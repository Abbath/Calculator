...
tests =
  ...
  , ("1 - -1", R 2)
  , ("1024/2/2/2", R 128)
  , ("f(x) = x", l "Function f/1")
  , ("f(g,x) = g(x)", l "Function f/2")
  , ("f(sin,m.pi)", R 0)
  , ("h() = 2", l "Function h/0")
  , ("hh = h()", l "Variable hh=2")
  , ("p(x,y) = x - y", l "Function p/2")
  , ("p(2,2)", R 0)
  , ("$(1,0) = x - y", l "Operator $ p=1 a=left")
  , ("2$2$2$2", R (-4))
  , ("2$2-2$2", R 0)
  , ("$(p(-),L) = x - y", l "Operator $ p=7 a=left")
  , ("2$2-2$2", R (-4))
  ...
  , ("52 `C` 5", R 2598960)
  , ("dms(10, 30, 0)", R 10.5)
  , ("smd(11.525)", l "11°31'30\"")
  , ("x, y = 4, 5", l "Variable x=4\nVariable y=5")
  , ("d, m, s = smd(11.525)", l "Variable d=11\nVariable m=31\nVariable s=30")
  ]
