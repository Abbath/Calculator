...
action_2 (9) = happyShift action_20
...
action_11 (9) = happyShift action_15
...
action_16 (9) = happyShift action_25
...
action_24 (12) = happyShift action_31
action_24 (13) = happyShift action_32
action_24 _ = happyFail

action_25 _ = happyReduce_11

action_26 (8) = happyShift action_30
...
action_32 (9) = happyShift action_34
...
action_36 (8) = happyShift action_37
...
happyReduction_6 (HappyAbsSyn5  happy_var_3)
	...
	(HappyTerminal (TOp happy_var_1))
	 =  HappyAbsSyn5
		 (OpCall happy_var_1 happy_var_2 happy_var_3
	)
...
happyReduction_9 (HappyTerminal (TNumber happy_var_1))
	 =  HappyAbsSyn5
		 (Number happy_var_1
	)
...
happyReduction_12 (HappyTerminal (TIdent happy_var_3))
	_
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TNumber happy_dollar_dollar -> cont 8;
	TIdent happy_dollar_dollar -> cont 9;
	TOp happy_dollar_dollar -> cont 10;
	TLPar -> cont 11;
	TRPar -> cont 12;
	TComma -> cont 13;
	TEqual -> cont 14;
	...
	TFun -> cont 17;
	TEnd -> cont 18;
	TFIdent happy_dollar_dollar -> cont 19;
	_ -> happyError' (tk:tks)
	}
